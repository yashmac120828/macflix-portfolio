        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
            ...
            <ul className="space-y-3">
              {[
                ...
                >
                  <motion.a 
                    href={link.href} 
                    className="text-white/70 hover:text-white transition-colors duration-300 flex items-center justify-center sm:justify-start group"
                    whileHover={{ x: 5 }}
                  >
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-6">
              {[
                { href: "https://wa.me/918780364562", icon: "whatsapp", color: "bg-[#25D366] hover:bg-[#22BC5C]", delay: 0 },
                { href: "https://instagram.com/mac_flix", icon: "instagram", delay: 0.1 },
                { href: "mailto:yashmachhi1408@gmail.com", icon: "mail", delay: 0.2 }
              ].map((social, index) => (
                <motion.a
                  key={social.icon}
                  href={social.href}
